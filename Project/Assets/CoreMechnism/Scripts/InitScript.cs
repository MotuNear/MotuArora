...
namespace InitScriptName
{
    ...
    public class InitScript : MonoBehaviour
    {
        ...
        public void SetData(){
            ...
            Gems = DatabaseManager.Instance.GetLocalData().data.Gems;
            Lifes = DatabaseManager.Instance.GetLocalData().data.Lifes;
        ...
        public void SaveLevelStarsCount2(int level, int starsCount)
        {
        ...
        public void AddLife(int count)
        {
               ...
               LocalData data = DatabaseManager.Instance.GetLocalData();
            data.data.Lifes += count;
            if (data.data.Lifes > CapOfLife)
                data.data.Lifes = CapOfLife;
            DatabaseManager.Instance.UpdateData(data);
        ...
        public void OnLevelClicked(object sender, LevelReachedEventArgs args)
        {
            ...
            {
                DatabaseManager.Instance.GetLocalData().data.OpenLevel = args.Number;                
